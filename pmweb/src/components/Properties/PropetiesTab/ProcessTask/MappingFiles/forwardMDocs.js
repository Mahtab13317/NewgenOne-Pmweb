...
function ForwardForDocuments(props) {
  ...
  const oneLineForMap = () => {
    return forwardDocsList?.map((el, index) => {
      return (
        <>
          <div
            id="processTaskId1"
          ...
          >
            ...
            >
              <Select
                id={`pmweb_ForwardMDocs_MappedField_${index}`}
            ...
            <div style={{ marginTop: "9px", flex: "0.2", textAlign: "center" }}>
              ...
              /> */}
            {/* <img
                id={`pmweb_ForwardMDocs_DeleteVarFromList_${index}`}
                src={deleteImage}
            ...
            */}
            ...
            >
              <LightTooltip
                id={`pmweb_ForwardMDocs_DeleteTooltip_${index}`}
                arrow={true}
      ...
      >
        ...
        <div
          style={{
            flex: "4",
            background: "white",
            overflowY: props.isDrawerExpanded ? "scroll" : "", // Added code on 14-09-2023 for BugID: 136160
            paddingLeft: "0.58vw",
          }}
        >
          <CommonTabHeader
            ...
            isReadOnly={isReadOnly}
            hideTargetCurrentHeader={forwardDocsList?.length === 0}
          />
          {forwardDocsList?.length > 0 ? (
            oneLineForMap()
          ) : (
            // <p
            //   className={
