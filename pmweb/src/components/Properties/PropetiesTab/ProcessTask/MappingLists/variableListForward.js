...
function VariableList(props) {
  ...
  useEffect(() => {
    ...
    if (props.selectedVariableList !== null) {
      let processID;
      if (
  ...
  useEffect(() => {
    ...
    console.log("111","has error",allTabStatus[propertiesLabel.fwdVarMappingProcessTask])
        ...
        {filteredRows?.length === 0 ? (
          ...
          <>
            ...
            >
              ...
              >
                <Checkbox
                  id={`pmweb_VariableListForward_SelectAll_${uuidv4()}`}
                  style={{
                    borderRadius: "1px",
                    padding: "0",
                  }}
            ...
            >
              {/*Modified on 22/05/2023, bug_id:127123*/}
              {filteredRows?.map((vary) => {
                return (
                  ...
                  >
                    ...
                    >
                      <Checkbox
                        id={`pmweb_VariableListForward_IndividualVarCheckbox_${uuidv4()}`}
                    ...
                    >
                      {getVariableType(vary.VarType).toUpperCase()}
                    </p>
                  </div>
                );
              })}
