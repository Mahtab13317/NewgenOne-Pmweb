      ...
      setSelectedDocuments((prev) => {
        ...
        varDefinition.map((el) => {
          ...
          temp.forEach((selectedDoc) => {
            if (selectedDoc.DocTypeId == el.DocTypeId) {
              isPresent = true;
            }
          });
          if (!isPresent) {
        ...
        {filteredRows?.length === 0 ? (
          ...
          <>
            ...
            >
              <label
                style={{ display: "none" }}
                htmlFor={`pmweb_DocReverseList_SelectAll_`}
              >
                Checkbox
              </label>
              <Checkbox
                id={`pmweb_DocReverseList_SelectAll_`}
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <label
                        style={{ display: "none" }}
                        htmlFor={`pmweb_DocReverseList_IndividualVarCheckbox_${index}`}
                      >
                        Checkbox
                      </label>
                      <Checkbox
                        id={`pmweb_DocReverseList_IndividualVarCheckbox_${index}`}
                        style={{
                          borderRadius: "1px",
                          padding: "0",
                        }}
