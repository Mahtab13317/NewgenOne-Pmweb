...
function RequireRightSection(props) {
  ...
  useEffect(() => {
    props?.completeSections?.map((section) => {
      ...
      setAttachList(props?.selectedOrder?.Attachment);
    });
        ...
        >
          ...
          <div style={{ height: "26vh" }}>
            <SunEditor
              ...
              getValue={(e) => textOneHandler(e)}
              zIndex="99" //Bug 117909 - [23-02-2023] Provided a zIndex
              disabled={isReadOnly}
              // idTag="textOne_description_sunEditor"
              handleChange={(e)=>{handleChange(e,"textOne")}} //Modified on 16/10/2023, bug_id:136034
            />
          </div>
          <p
            style={{
          ...
          <div aria-label="textEditor" style={{ height: "26vh" }}>
            <SunEditor
             ...
             /* value={
              ...
              getValue={(e) => textTwoHandler(e)}
              disabled={isReadOnly}
              handleChange={(e)=>{handleChange(e,"textTwo")}}
            />
          </div>
        </div>
        {/* ----------------------------Attachments Table------------------------------- */}
